...
void PointCloudCity::selfSetupGuis(){
...
void PointCloudCity::selfSetupSystemGui(){
...
void PointCloudCity::guiSystemEvent(ofxUIEventArgs &e){
    string name = e.widget->getName();
}

void PointCloudCity::selfSetupRenderGui(){
    rdrGui->addToggle("Show_Pano", &bShowPano);
}

void PointCloudCity::guiRenderEvent(ofxUIEventArgs &e){
    string name = e.widget->getName();
}

void PointCloudCity::selfUpdate(){
    uiMap.update();
    sv.update();
...
void PointCloudCity::addLook(StreetView &_sv, ofPoint _center){
...
void PointCloudCity::selfDrawOverlay(){
    if(bDebug){
...
void PointCloudCity::selfKeyPressed(ofKeyEventArgs & args){
...
void PointCloudCity::selfKeyReleased(ofKeyEventArgs & args){
}

void PointCloudCity::selfMouseMoved(ofMouseEventArgs& data){
}

void PointCloudCity::selfMousePressed(ofMouseEventArgs& data){
    if (bDebug){
...
void PointCloudCity::selfMouseDragged(ofMouseEventArgs& data){
    if (bDebug){
        ofPoint areaPos = ofPoint(ofGetWidth()-uiMap.getWidth()-10, +10);
        ofRectangle area = ofRectangle(areaPos,uiMap.getWidth(),uiMap.getHeight());
...
void PointCloudCity::selfMouseReleased(ofMouseEventArgs& data){
    camera->enableMouseInput();
}

void PointCloudCity::selfWindowResized(ofResizeEventArgs & args){
